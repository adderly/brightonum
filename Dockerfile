...
RUN go test -run '^(TestAuthService_CreateUser|TestAuthService_RefreshToken|TestAuthService_ResetPassword|TestAuthService_DeleteUser|TestCrypto)$' github.com/adderly/brightonum/src
